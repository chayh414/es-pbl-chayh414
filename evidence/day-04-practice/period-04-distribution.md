...
- 선택 유형: 분포
- 사용자 질문: 가격이 어느 구간에 몰려 있는가? (Q1 "3만원 이하" 조건과 연결)
- field와 mapping type: price (integer)
- 그룹/구간/시간 단위: Custom ranges — 0~30,000 / 30,000~60,000 / 60,000~90,000 / 90,000~120,000 / 120,000~150,000
- 차트: Bar
- 완료 기준: 5개 구간이 모두 표시되고 Count 합이 5,000과 일치
- 실제 결과 또는 부족한 데이터: 실제 제작 완료. 0~30,000(약 825) < 30,000~60,000(약1,010) ≈ 60,000~90,000(약1,025) ≈ 90,000~120,000(약1,050) < 120,000~150,000(약1,100)으로 완만한 증가 추세. 120,000~150,000 구간이 최다
- 해석 시 주의할 한계: 첫 구간(0~30,000)만 유독 적어 보이는데, 이는 실제 price 최솟값이 5,000원이라 이 구간이 25,000원 폭만 채우고 나머지 구간은 30,000원 폭을 다 채우기 때문이다(구간 폭이 달라 생긴 착시). 절대 건수만 보면 "저가 상품이 적다"고 오해할 수 있어 구간 폭 차이를 감안해서 해석해야 함
